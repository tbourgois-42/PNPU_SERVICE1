      ...
      <div class="text-center">
        <v-content class="pa-0">
          <v-toolbar dense flat>
            ...
            <v-toolbar-title>Dashboard | Workflow {{ workflowDate }}</v-toolbar-title>
            ...
            <v-menu>
              ...
              <v-list v-model="workflows.name">
                <v-list-item v-for="workflow in workflows"
                             :key="workflow"
          ...
          <v-col v-for="avancement in avancements" :key="avancement.id" md="4">
            <v-card @click.prevent="filter = avancement.title">
              <v-card-text>
                ...
                <v-progress-linear :color="avancement.color"
                                   height="10"
                ...
                <template v-slot="{ hover }">
                  <router-link :to="{
                    ...
                    <v-card :elevation="hover ? 6 : 1"
                      ...
                      <div>
                        <v-card-title class="headline subtitle-2 text-uppercase">{{ item.client }}</v-card-title>
                        <v-card-subtitle>Step {{ item.step }} / {{ max }}</v-card-subtitle>
                        <v-card-subtitle>{{ item.typologie }}</v-card-subtitle>
                        <v-chip v-if="item.step == 10"
