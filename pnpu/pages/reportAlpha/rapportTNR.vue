...
<script>
import reportTNR from '../../data/ReportTNR.json'
export default {
  components: {},
  data: () => ({
    title: 'Report',
    subTitle: 'Subtitle',
    JSON_TEMPLATE: reportTNR,
    titleTable: 'Tests de Non Régression (TNR)',
    headers: [],
    searchTreeview: null,
    searchTable: null,
    caseSensitive: false,
  ...
  created() {
    this.titleTable = this.JSON_TEMPLATE[0].name
    this.selectedItemTable = this.JSON_TEMPLATE[0].children
