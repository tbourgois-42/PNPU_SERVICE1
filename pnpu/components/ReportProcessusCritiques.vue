      ...
      <v-col cols="8">
        <v-list-item-group class="mb-5 d-flex">
          ...
          <v-checkbox
            ...
            label="Voir uniquement les traitements en erreur"
            hide-details
        ...
        <transition appear name="fade">
          ...
          >
            Pour plus d'informations, veuillez consulter les logs du planificateur de tâches.
          </v-alert>
        </transition>
        ...
        <transition appear name="fade">
          <v-alert
            ...
            type="success"
          >
            Le processus s'est déroulé avec succes.
          </v-alert>
        </transition>
      </v-col>
    </v-row>
    ...
    getSelected(e) {
      if (e.length > 0) {
        for (const selectedItem of e) {
          this.showAlertMessage = (selectedItem.result === this.iconAlert && selectedItem.children === undefined) ? true : false
