    ...
    items: [
      {
        ...
        debut: '09/06/20 9:52:08',
        fin: '09/06/20 9:52:22',
        children: [
          {
            id: '2',
            name: '8.1.6_HF1213.mdb',
            result: 'mdi-alert-circle',
            children: [
              {
                id: '201',
                ...
                message: [
                  {
                    id: '2061',
                    name:
                      'La présentation SCO_DP_PAYROLL_CHANNEL est livrée dans le pack 8.1.6_HF1213_SFR_153409_L.'
                  }
                ]
              },
              {
              ...
              },
              {
                ...
                message: [
                  {
                    id: '2141',
                    name: 'Tâche SFR_EXPORT_FICHIER_ASP non sécurisée.'
                  }
                ]
              },
              {
